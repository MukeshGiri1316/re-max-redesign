...
const LISTINGS = [
  {
    ...
    price: "€1,250,000",
    tag: "Sea View",
    badge: "bg-[var(--color-gold-soft)] text-[var(--color-gold)]",
    views: 312,
  ...
  },
  {
    ...
    price: "€695,000",
    tag: "New Listing",
    badge: "bg-[var(--color-red-soft)] text-[var(--color-red)]",
    views: 219,
  ...
  },
  {
    ...
    price: "€2,100,000",
    tag: "Exclusive",
    badge: "bg-[var(--color-blue)]/10 text-[var(--color-gold)]",
    views: 487,
  ...
  },
  {
    ...
    price: "€480,000",
    tag: "High Demand",
    badge: "bg-[var(--color-urgent)]/10 text-[var(--color-urgent)]",
    views: 178,
...
export function FeaturedListings() {
  ...
  // ⏸ Pause + resume after delay
  const pauseWithDelay = () => {
    stopAuto();
  ...
  return (
    <section className="py-16 px-5 bg-[var(--color-bg)] overflow-hidden">
          ...
          <div className="flex flex-wrap justify-between items-end gap-4 mb-10">
            <div>
              ...
              <h2 className="text-[clamp(26px,4vw,42px)] font-semibold text-[var(--color-dark)] leading-tight">
                Featured Properties <br /> Across Malta & Gozo
              </h2>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-[180px] sm:h-[200px] md:h-[210px] overflow-hidden">
                    ...
                    <img
                      src={l.image}
                      className="w-full h-full object-cover group-hover:scale-105 sm:group-hover:scale-110 duration-300"
                    />
